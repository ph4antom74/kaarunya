     ...
     return (
        <View style = {styles.background}>
           <View style={styles.contentHeads}>
             ...
             <Text style={styles. mainHead}>Nurse</Text>
             </View> 
           ...
           />
            ...
            <View style={styles.createCenter}>
             <TouchableOpacity   style={styles.button2}  onPress={()=> navigation.navigate('CreateNurse')}>
                <Text style={styles.CCtext}>New Nurse</Text>
            </TouchableOpacity>
            </View>
