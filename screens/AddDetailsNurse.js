...
const AddDetailsNurse=({ navigation,route }) => {
    ...
    return (
          ...
          <ScrollView >
          <View style={{backgroundColor:'#2c6b82',alignContent:'center',alignItems:'center'}} >
        <Text style={{marginTop:'15%',alignItems:'center',color: '#fff',fontWeight: 'bold',fontSize: 40,marginBottom:'8%'}}>Add Details</Text>
        </View>
      <View style={styles.background}>
         <View style={{paddingTop:100}}></View>
      <View style={{flexDirection:'row'}}>
         <Text style={{marginLeft:'5%',fontSize:20}}>Name:{name}</Text>
         <Text style={{marginLeft:'10%',fontSize:20}}>Age:{age}</Text>
      </View>
